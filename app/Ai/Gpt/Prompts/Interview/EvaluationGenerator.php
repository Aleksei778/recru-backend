...
class EvaluationGenerator
{
    ...
    private function generate(Interview $interview): string
    {
        ...
        $prompt .= "Ты — профессиональный IT-рекрутер. Твоя задача — оценить ответы кандидата на вакансию: '$vacancy->title'.
            ...
            Делай скидку на то, что кандидат отвечает голосом и слова могут распознаваться иногда не лучшим образом, всякие технические термины можешь додумывать, но без перебора";
